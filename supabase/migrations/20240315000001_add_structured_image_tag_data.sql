-- Migration to add structured image and tag data tracking
-- This replaces the simple image_urls and tags arrays with structured data
...
CREATE INDEX idx_events_image_data ON test_calendar_events USING GIN (image_data);
CREATE INDEX idx_events_tag_data ON test_calendar_events USING GIN (tag_data);
